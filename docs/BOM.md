...
| 16 | Wire, heat-shrink, bulk caps, headers | ~22AWG for motor, ~26AWG signal; 470–1000µF across the motor rail **+ 0.1 µF ceramic across the motor terminals for brush noise, and 0.1 µF at the TB6612 VM/GND** (added 2026-09-02 — `docs/WIRING_PROTOSHIELD.md` §2.2 flagged both as missing from this row) | **$73.82** | [Fermerry 22 AWG wire, 6×25ft](https://www.amazon.com/Fermerry-Stranded-Silicone-Flexible-Electrical/dp/B089D29FHC) $20.49 · [Fermerry 26 AWG wire, 6×50ft](https://www.amazon.com/Fermerry-Tinned-Electrical-Silicone-Stranded/dp/B089CSCY8S) $24.99 · [KOOWIN heat-shrink, 720pc/8 sizes](https://www.amazon.com/Shrink-Tubing-Tubes-KOOWIN-Ratio/dp/B098LB9LTJ) $7.99 · [470µF 25V caps, 10-pack](https://www.amazon.com/Projects-Radial-Electrolytic-Capacitor-470uF/dp/B0CPTDPG6S) $7.07 · [0.1µF ceramic caps, 50-pack](https://www.amazon.com/BOJACK-Capacitors-Low-Voltage-Dielectric-Capacitor/dp/B07X5XTDPB) $6.99 · [40-pin 0.1" headers, 20-pack](https://www.amazon.com/Straight-Breakaway-Connector-Breadboard-Electronic/dp/B0FRZW75VS) $6.29 — ✅ all verified 2026-09-03, In Stock |
| **Lighting + I/O** |
...
| | | **TOTAL (sum of rows, current prices)** | **$452.20** | |
...
| **Amazon (folded 2026-09-03)** | [MG90S metal-gear servo, 2-pack](https://www.amazon.com/Replace-Helicopter-Airplane-Controls-Vehicle/dp/B09KXM5L7Z) $7.99 · [Arduino Uno proto shield, 2-pack + breadboard](https://www.amazon.com/HiLetgo-Prototype-Expansion-Breadboard-ProtoShield/dp/B00HHYBWPO) $7.79 · [XT30 pairs, genuine Amass, 20-pack](https://www.amazon.com/Amass-Upgrade-Female-Connectors-Battery/dp/B0CFFJK4XH) $11.99 · [ATO/ATC fuse holder + 70 assorted fuses incl. 3A, 10-pack](https://www.amazon.com/MADCATZ-AWG-Line-Automotive-Replacement/dp/B0DT15YKF2) $9.98 · [SPST rocker switch 10A, 10-pack](https://www.amazon.com/Piece-Black-Rocker-Switch-KCD1-110/dp/B07KMKT9F1) $15.00 · [470µF 25V electrolytic caps, 10-pack](https://www.amazon.com/Projects-Radial-Electrolytic-Capacitor-470uF/dp/B0CPTDPG6S) $7.07 · [0.1µF ceramic caps, 50-pack](https://www.amazon.com/BOJACK-Capacitors-Low-Voltage-Dielectric-Capacitor/dp/B07X5XTDPB) $6.99 · [3mm white LED + resistors, 100-pack](https://www.amazon.com/EDGELEC-Diffused-Resistors-Included-Emitting/dp/B077XFLX13) $6.99 · [3mm red LED + resistors, 100-pack](https://www.amazon.com/EDGELEC-Diffused-Resistors-Included-Emitting/dp/B077X96JVG) $6.99 · [3mm orange/amber LED + resistors, 100-pack](https://www.amazon.com/EDGELEC-Orange-Orange-Diffused-Resistors-Included/dp/B077X956X7) $6.99 · [30-value resistor kit, 600pcs, 1Ω-1MΩ](https://www.amazon.com/KSOPUERT-Resistor-Assortment-Resistance-Values/dp/B0CN6N5DC4) $7.38 · [Fermerry 22 AWG wire, 6×25ft](https://www.amazon.com/Fermerry-Stranded-Silicone-Flexible-Electrical/dp/B089D29FHC) $20.49 · [Fermerry 26 AWG wire, 6×50ft](https://www.amazon.com/Fermerry-Tinned-Electrical-Silicone-Stranded/dp/B089CSCY8S) $24.99 · [KOOWIN heat-shrink, 720pc/8 sizes](https://www.amazon.com/Shrink-Tubing-Tubes-KOOWIN-Ratio/dp/B098LB9LTJ) $7.99 · [40-pin 0.1" headers, 20-pack](https://www.amazon.com/Straight-Breakaway-Connector-Breadboard-Electronic/dp/B0FRZW75VS) $6.29 · [Dupont jumpers, 120pc M-M/M-F/F-F](https://www.amazon.com/EDGELEC-Optional-Breadboard-Assorted-Multicolored/dp/B07GCZ52WF) $6.98 · [Amazon Basics USB-A-to-B cable, 6ft](https://www.amazon.com/Amazon-Basics-External-Gold-Plated-Connectors/dp/B00NH11KIK) $5.12 | **$167.02** *(all 17 items live-verified 2026-09-03)* | ✅ **RESOLVES THE OLD "small-order problem" ROW ENTIRELY** — the SPST rocker, XT30 pair and fuse holder all now ship in the SAME Amazon order as the BMS (row 11b) and servo, ending the 3-separate-vendor situation for $4.80 of parts. |
...
**Update 2026-09-03: the last six Amazon-row items are now live-verified too** (22 AWG wire, 26 AWG wire, heat shrink, headers, Dupont jumpers, USB-A-to-B cable — the earlier note called them "the last five" because 22 AWG and 26 AWG were one bullet). Same standard as everything else in this row: title, price and stock read off the rendered page, not a search snippet. **They came in over the earlier $35–$45 guess: $71.86 for all six**, driven mostly by the two wire kits ($20.49 + $24.99 = $45.48 alone — more than the entire old budget). Picked: Fermerry stranded silicone wire (6 colors × 25ft for 22 AWG, × 50ft for 26 AWG — flexible insulation over plain PVC, which matters on a car that vibrates), a KOOWIN 720pc heat-shrink assortment, a 40-pin single-row 0.1" breakaway header 20-pack, an EDGELEC 120pc Dupont kit covering all three connector types (M-M/M-F/F-F), and the Amazon Basics USB-A-to-B cable needed for the Pi↔Uno serial link. ⚠️ The USB cable listing showed only 9 left in stock at check time — a real but minor reorder risk if it sells through before Evan checks out. **Every remaining unlinked "any" placeholder in this BOM is now closed.**

⚠️ **CONSOLIDATION IS NOT FREE, AND THE JUMP IS LARGER THAN THE FIRST ESTIMATE — stated plainly rather than buried in a table.** Folding the small-order items and the generic parts onto Amazon (2026-09-03) cost **+$135.47 to +$141.72** over the previous piecemeal estimate, almost entirely because Amazon's hobby sellers sell in bulk packs, not the 1x quantities this build actually needs: **1 of 10** rocker switches, **1 of 20** XT30 pairs, **8 of 300** LEDs, **~20 of 600** resistors, **1 of 10** fuse holders, **1 of 6** wire spools per gauge. This is the same pattern as the ACEIRMC BMS (Appendix CO) — the individual per-unit price is often *cheaper* than the old single-unit sources — but repeated across ~17 items the cumulative overshoot is real money, not a rounding error. **The figure grew from an earlier +$104.86–$108.61 estimate once the last six commodity items were live-verified instead of budget-guessed — the guess ($35–45) turned out to be low by about $27–$37.** **This is a genuine tradeoff (fewer vendors, no more sub-shipping-cost line items, no more CAD currency problem — for about $135–$142 more), and it has not been decided for Evan.**

**SUM OF ROWS: $452.20** before shipping (up from $415.34–$425.34; a single precise figure now, not a range — every row in the BOM has a live-verified price as of 2026-09-03, including the last six commodity items). With shipping now concentrated mostly on ONE Amazon order (free with Prime or over $35, easily cleared) plus Vilros/Pololu/IMR/Adeept/DigiKey separately:
**≈$465 – $480 all-in** — a rough estimate, since per-vendor shipping was not re-summed line by line after this consolidation.
