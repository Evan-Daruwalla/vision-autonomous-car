...
| | | **TOTAL (sum of rows, current prices)** | **$310.48 – $316.73** | |
...
|---|---|---|---|
| **Vilros** | Basic Starter Kit, 4GB (includes SD card, cooling, PSU, HDMI adapter, storage bag, RTC connector, camera adapter cable of unconfirmed fit) | **$179.99** | FINAL, Evan 2026-09-03, confirmed in stock at checkout |
| **DigiKey** | Camera Module 3 Wide **SC1224** $35.00 · camera cable 200 mm **SC1892** $1.00 — ⚠️ **keep both until the kit's bundled camera cable is checked against Camera Module 3 Wide on arrival**; if it fits, drop SC1892 ($1.00) | **$36.00** | $4.99 USPS Ground Advantage, **no free threshold** |
...
| **general / any** | ~~microSD $21.95~~ **in the Vilros kit** · MG90S ~$5.00 · wire+shrink+caps+headers ~$8.00 · LEDs ~$1.50-3 · resistors ~$1-2 · Dupont + data-only USB ~$2-4 · proto shield ~$3-4 · coupling $0-0.75 | **~$20.50-26.75** | no vendor constraint; fold into whichever order is cheapest to grow |
...
**SUM OF ROWS: $310.48 – $316.73** before shipping (up from $262.44–$268.69: the Vilros kit adds $179.99 in place of the bare-board $110.00 row 1 and the now-superseded $21.95 row 4, a net **+$48.04** for one shipment covering the Pi, SD card, cooling and PSU). With shipping across 3-4 remaining vendors at $15-25:
**≈$325 – $342 all-in.**
