...
| **Amazon** | [ACEIRMC 2S 8A BMS](https://www.amazon.com/dp/B08HLQQCQJ) | **$9.59** | the safety-critical half; cutoff 2.9 V ±0.05 V |
...
| **general / any** | ~~microSD $21.95~~ **in the Vilros kit** · MG90S ~$5.00 · wire+shrink+caps+headers ~$8.00 · LEDs ~$1.50-3 · resistors ~$1-2 · Dupont + data-only USB ~$2-4 · proto shield ~$3-4 · coupling $0-0.75 | **~$20.50-26.75** | no vendor constraint, so no links pinned — fold into whichever order is cheapest to grow |
| **small-order problem** | [SPST rocker](https://www.sparkfun.com/products/11138) $0.75 (SparkFun) · [XT30 pair](https://alofthobbies.com/products/xt30-plugs) $1.10 (AloftHobbies) · [fuse holder](https://bc-robotics.com/shop/inline-ato-atc-fuse-holder-14awg/) $2.95 CAD (bc-robotics) | **~$4.80** | ⚠️ **each of these costs less than its own shipping.** Find US substitutes and fold them into a larger order rather than paying three separate freights |
